function calculate() 
{
	...
	let fuelСost = kmPerDay * 0.42;
	let carIncome = netOrderEarnings - fuelСost;
   	...
   	let totalExpenses = parking + foodExpenses + fuelСost;
	...
	document.getElementById("fuel_cost").innerText = fuelСost.toFixed(2) + " PLN"; 
